 ...
 * map generation logic (when used as the central map object), and serves as the application entry point.
 *
 * @author  Jack Schulte
 * @version 1.0.7
 * @date    2025-04-14
 ...
 */
 ...
 import javax.swing.*; // Import necessary for invokeLater
 ...
 public class RPG {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            UIManagement.setupUI(); // Call the public static setup method
            UIManagement.titleScreen(); // Start the UI flow
            UIManagement.frame.setVisible(true); // Make the frame visible (assuming frame is public static)
        });
    }
     ...
     // --- Public Static Getters for Class Template Stats --- ADDED
     public static int getKnightMaxHp() { return knight.maxHp; }
     public static int getKnightMaxEnergy() { return knight.maxEnergy; }
     public static int getSentinelMaxHp() { return sentinel.maxHp; }
     public static int getSentinelMaxEnergy() { return sentinel.maxEnergy; }
     public static int getAssassinMaxHp() { return assassin.maxHp; }
     public static int getAssassinMaxEnergy() { return assassin.maxEnergy; }
     public static int getCavemanMaxHp() { return caveman.maxHp; }
     public static int getCavemanMaxEnergy() { return caveman.maxEnergy; }
